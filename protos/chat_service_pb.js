...
goog.exportSymbol('proto.backend.chat_service.CreateChatMessageAck', null, global);
 ...
 * @constructor
 */
proto.backend.chat_service.CreateChatMessageAck = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.backend.chat_service.CreateChatMessageAck, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.backend.chat_service.CreateChatMessageAck.displayName = 'proto.backend.chat_service.CreateChatMessageAck';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.backend.chat_service.CreateChatMessageAck.prototype.toObject = function(opt_includeInstance) {
  return proto.backend.chat_service.CreateChatMessageAck.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.backend.chat_service.CreateChatMessageAck} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.backend.chat_service.CreateChatMessageAck.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.backend.chat_service.CreateChatMessageAck}
 */
proto.backend.chat_service.CreateChatMessageAck.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.backend.chat_service.CreateChatMessageAck;
  return proto.backend.chat_service.CreateChatMessageAck.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.backend.chat_service.CreateChatMessageAck} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.backend.chat_service.CreateChatMessageAck}
 */
proto.backend.chat_service.CreateChatMessageAck.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.backend.chat_service.CreateChatMessageAck.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.backend.chat_service.CreateChatMessageAck.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.backend.chat_service.CreateChatMessageAck} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.backend.chat_service.CreateChatMessageAck.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.backend.chat_service.CreateChatMessageAck.prototype.getCorrelationId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.backend.chat_service.CreateChatMessageAck} returns this
 */
proto.backend.chat_service.CreateChatMessageAck.prototype.setCorrelationId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
